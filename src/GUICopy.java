...
public class GUICopy {
    ...
    public static void battle(String playerOneName, String playerTwoName, nPlayer P1, nPlayer P2) {
        ...
        // move entry jTextfield for player1
        JTextField playerTwoMove = new JTextField("Enter An Attack: ", 10);

        playerTwoMove.setBounds(535, 315, 110, 20);
        ...
        health1.setBounds(500, 200, 115, 100);
        // set healthbar for 1st player
        health2.setBounds(100, 300, 115, 100);
        ...
        LayeredPane.add(playerOneMove);

        LayeredPane.add(playerTwoMove);
        ...
        // // adding Label with background image in it to imagePanel so imagePanel can
        // be added to battlePage
        // // frame
        ...
        // // adding pokeOneLabel with background image in it to imagePanel so
        // imagePanel can be added to battlePage
        // // frame
        ...
        // // adding pokeTwoLabel with background image in it to imagePanel so
        // imagePanel can be added to battlePage
        // // frame
